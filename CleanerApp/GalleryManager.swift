...
struct CoreDataPHAssetManager{
    ...
    private func addNewPHAssetsInCoreData(){
    ...
    func processSimilarAssets(firstAsset: CustomAsset, secondAsset: CustomAsset){
        ...
        if let subgroupId = firstAsset.subGroupId{
            secondAsset.subGroupId = subgroupId
            return
        }
        
        if let subGroupId = secondAsset.subGroupId{
    ...
    private func addNewPHAssetsTypeInCoreData(mediaType: PHAssetCustomMediaType){
        ...
        var savedCustomPHAssets = CoreDataManager.shared.fetchCustomAssets(
            context: context,
            mediaType: mediaType,
            groupType: nil,
            shoudHaveSHA: nil,
