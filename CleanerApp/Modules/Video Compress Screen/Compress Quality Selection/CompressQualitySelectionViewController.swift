...
class CompressQualitySelectionViewController: UIViewController {
    ...
    static func initWith(compressAsset: CompressVideoModel) -> CompressQualitySelectionViewController{
        ...
        let vc = UIStoryboard.videoCompress.instantiateViewController(withIdentifier: CompressQualitySelectionViewController.className) as! CompressQualitySelectionViewController
